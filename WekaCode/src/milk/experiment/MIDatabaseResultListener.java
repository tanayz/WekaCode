 ...
 */
public class MIDatabaseResultListener extends MIDatabaseUtils
  implements MIResultListener  {
   ...
   */
  public MIDatabaseResultListener() throws Exception {
   ...
   * @exception Exception if an error occurs.
   */
  public String [] determineColumnConstraints(MIResultProducer rp) 
    throws Exception {
   ...
   * @exception Exception if an error occurs
   */
  protected void updateResultsTableName(MIResultProducer rp) throws Exception {
   ...
   * @exception Exception if an error occurs
   */
  protected boolean isKeyInCache(MIResultProducer rp, Object[] key)
    throws Exception {
   ...
   * @exception Exception if an error occurs
   */
  protected void loadCache(MIResultProducer rp, Object[] key)
    throws Exception {
