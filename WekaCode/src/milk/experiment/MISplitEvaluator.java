 ...
 * fields related to any settings of the MISplitEvaluator (not including
 ...
 *
 * Possible implementations of MISplitEvaluator: <br>
 * <ul>
 ...
 */
public interface MISplitEvaluator extends Serializable {
  
  /**
   * Sets a list of method names for additional measures to look for
   * in MISplitEvaluators.
  ...
  /**
   * Gets the key describing the current MISplitEvaluator. For example
   ...
   */
  Object [] getResult(Exemplars train, Exemplars test) throws Exception;
