...
/*
 *    MICrossValidationResultProducer.java
 ...
 */
public class MICrossValidationResultProducer 
  ...
  public void setAdditionalMeasures(String [] additionalMeasures) {
    ...
    if (m_SplitEvaluator != null) {
      System.err.println("MICrossValidationResultProducer: setting additional "
			 +"measures for "
			 +"split evaluator");
  ...
  public double getMeasure(String additionalMeasureName) {
	...
	getMeasure(additionalMeasureName);
      ...
      throw new IllegalArgumentException("MICrossValidationResultProducer: "
  ...
  public String toString() {
    ...
    String result = "MICrossValidationResultProducer: ";
