 ...
 */
public class MIClassifierSplitEvaluator implements MISplitEvaluator, 
  OptionHandler, AdditionalMeasureProducer {
  
  /** The classifier used for evaluation */
  protected MIClassifier m_Classifier = new TLDSimple();
   ...
   * No args constructor.
   */
  public MIClassifierSplitEvaluator() {
  ...
  public void setAdditionalMeasures(String [] additionalMeasures) {
    // System.err.println("MIClassifierSplitEvaluator: setting additional measures");
  ...
  public double getMeasure(String additionalMeasureName) {
	...
	getMeasure(additionalMeasureName);
      ...
      throw new IllegalArgumentException("MIClassifierSplitEvaluator: "
   ...
   */
  public Object [] getResult(Exemplars train, Exemplars test) 
    throws Exception {
    ...
    MIEvaluation eval = new MIEvaluation(train);
    ...
    int current = 0;
    result[current++] = new Double(train.numExemplars());
    result[current++] = new Double(eval.numExemplars());
   ...
   */
  public MIClassifier getClassifier() {
   ...
   */
  public void setClassifier(MIClassifier newClassifier) {
  ...
  public void setClassifierName(String newClassifierName) throws Exception {
    ...
    try {
      setClassifier((MIClassifier)Class.forName(newClassifierName)
		    .newInstance());
    } catch (Exception ex) {
  ...
  public String toString() {
    ...
    String result = "MIClassifierSplitEvaluator: ";
    if (m_Classifier == null) {
