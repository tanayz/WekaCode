...
/*
 *    MIRandomSplitResultProducer.java
...
public class MIRandomSplitResultProducer 
  implements MIResultProducer, OptionHandler, AdditionalMeasureProducer {
  ...
  protected MISplitEvaluator m_SplitEvaluator = new MIClassifierSplitEvaluator();
  ...
  public void setAdditionalMeasures(String [] additionalMeasures) {
    ...
    if (m_SplitEvaluator != null) {
      System.err.println("MIRandomSplitResultProducer: setting additional "
			 +"measures for "
			 +"split evaluator");
  ...
  public double getMeasure(String additionalMeasureName) {
	...
	getMeasure(additionalMeasureName);
      ...
      throw new IllegalArgumentException("MIRandomSplitResultProducer: "
   ...
   */
  public void setResultListener(MIResultListener listener) {
  ...
  public void doRun(int run) throws Exception {
	...
	if (runInstances.classAttribute().isNominal()) {
	  ...
	  for (int i = 0; i < numClasses + 1; i++) {
	    int trainSize = 
	      Utils.probRound(subsets[i].numExemplars() * m_TrainPercent / 100, rand);
	  ...
	  // Numeric target 
	  int trainSize = 
	    Utils.probRound(runInstances.numExemplars() * m_TrainPercent / 100, rand);
	  int testSize = runInstances.numExemplars() - trainSize;
	  train = new Exemplars(runInstances, 0, trainSize);
	  test = new Exemplars(runInstances, trainSize, testSize);
	}
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    // SE.
    setSplitEvaluator((MISplitEvaluator)Utils.forName(
		      MISplitEvaluator.class,
		      seName,
		      null));
  ...
  public String toString() {
    ...
    String result = "MIRandomSplitResultProducer: ";
