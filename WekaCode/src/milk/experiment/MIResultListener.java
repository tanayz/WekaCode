...
public interface MIResultListener extends Serializable {
   ...
   */
  String [] determineColumnConstraints(MIResultProducer rp) 
    throws Exception;
   ...
   */
  void preProcess(MIResultProducer rp) throws Exception;
   ...
   * @exception Exception if an error occurs
   */
  void postProcess(MIResultProducer rp) throws Exception;
   ...
   */
  void acceptResult(MIResultProducer rp, Object [] key, Object [] result)
    throws Exception;
   ...
   * is needed.
   */
  boolean isResultRequired(MIResultProducer rp, Object [] key) 
    throws Exception;
