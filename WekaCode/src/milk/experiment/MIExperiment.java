...
public class MIExperiment implements Serializable, OptionHandler {
  ...
  protected transient Exemplars m_CurrentInstances;
   ...
   */
  public MIResultListener getResultListener() {
   ...
   */
  public MIResultProducer getResultProducer() {
  ...
  public void setOptions(String [] options) throws Exception {
    ...
    setResultListener((MIResultListener)Utils.forName(MIResultListener.class,
						    clName, rlOptions));
    ...
    setResultProducer((MIResultProducer)Utils.forName(
		      MIResultProducer.class,
		      rpName,
