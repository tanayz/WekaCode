 ...
 */
public class MIDatabaseUtils implements Serializable {
   ...
   */
  public MIDatabaseUtils() throws Exception {
  ...
  public Object [] getResultFromTable(String tableName,
	...
	throw new Exception("Unhandled SQL result type (field " + (i + 1)
			    + "): "
			    + MIDatabaseUtils.typeName(md.getColumnType(i)));
      }
    }
    if (rs.next()) {
      throw new Exception("More than one result entry "
   ...
   * @exception Exception if an error occurs.
   */
  public String createExperimentIndexEntry(MIResultProducer rp)
    throws Exception {
   ...
   * @exception Exception if an error occurs
   */
  public String getResultsTableName(MIResultProducer rp) throws Exception {
   ...
   * @exception Exception if an error occurs.
   */
  public String createResultsTable(MIResultProducer rp, String tableName)
    throws Exception {
