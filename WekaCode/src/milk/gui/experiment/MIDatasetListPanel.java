 ...
 */
public class MIDatasetListPanel extends JPanel implements ActionListener {
   ...
   */
  public MIDatasetListPanel(MIExperiment exp) {
  ...
  public static void main(String [] args) {
    ...
    try {
      ...
      MIDatasetListPanel dp = new MIDatasetListPanel();
	...
	public void windowClosing(WindowEvent e) {
      ...
      dp.setExperiment(new MIExperiment());
    } catch (Exception ex) {
      ex.printStackTrace();
