...
import milk.experiment.MIRemoteExperiment;
...
public class MIDistributeExperimentPanel extends JPanel {

  /**
   * The experiment to configure.
   */
  MIRemoteExperiment m_Exp = null;
  ...
  /** The host list panel */
  protected MIHostListPanel m_hostList = new MIHostListPanel();
   ...
   * Constructor
   */
  public MIDistributeExperimentPanel() {
   ...
   */
  public MIDistributeExperimentPanel(MIExperiment exp) {
    this();
    setExperiment(exp);
  }
  ...
  public void setExperiment(MIExperiment exp) {
    ...
    m_Exp = null;
    if (exp instanceof MIRemoteExperiment) {
      m_Exp = (MIRemoteExperiment)exp;
  ...
  public static void main(String [] args) {
    try {
      ...
      jf.getContentPane().setLayout(new BorderLayout());
      jf.getContentPane().add(new MIDistributeExperimentPanel(new MIExperiment()),
			      BorderLayout.CENTER);
      jf.addWindowListener(new WindowAdapter() {
	public void windowClosing(WindowEvent e) {
	  jf.dispose();
