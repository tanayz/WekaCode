...
public class MIHostListPanel extends JPanel implements ActionListener {
  
  /** The remote experiment to set the host list of */
  protected MIRemoteExperiment m_Exp;
 ...
 /** The component displaying the host list */
   ...
   */
  public MIHostListPanel(MIRemoteExperiment exp) {
    this();
    setExperiment(exp);
  }
   ...
   * @param exp a value of type 'Experiment'
   */
  public void setExperiment(MIRemoteExperiment exp) {
    m_Exp = exp;
  ...
  public static void main(String [] args) {
    ...
    try {
      ...
      MIHostListPanel dp = new MIHostListPanel();
