 ...
 */
public class MIGeneratorPropertyIteratorPanel extends JPanel
   ...
   */
  public MIGeneratorPropertyIteratorPanel() {
   ...
   */
  public MIGeneratorPropertyIteratorPanel(MIExperiment exp) {
  ...
  public static void main(String [] args) {
    ...
    try {
      ...
      MIGeneratorPropertyIteratorPanel gp = new MIGeneratorPropertyIteratorPanel();
	...
	public void windowClosing(WindowEvent e) {
      ...
      gp.setExperiment(new MIExperiment());
    } catch (Exception ex) {
      ex.printStackTrace();
