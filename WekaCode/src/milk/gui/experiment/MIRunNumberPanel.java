 ...
 */
public class MIRunNumberPanel extends JPanel {
   ...
   */
  public MIRunNumberPanel(MIExperiment exp) {
  ...
  public static void main(String [] args) {
    ...
    try {
      ...
      jf.getContentPane().add(new MIRunNumberPanel(new MIExperiment()),
			      BorderLayout.CENTER);
